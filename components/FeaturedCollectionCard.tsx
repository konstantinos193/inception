        ...
        <div className="absolute inset-0 flex items-end p-6 sm:p-8 md:p-10">
          <div className="w-full flex flex-col sm:flex-row sm:items-end justify-between gap-6">
            ...
            <div className="flex flex-col gap-3 min-w-0">
              ...
              <p className="text-sm text-white/70 leading-relaxed max-w-md line-clamp-2">
                {project.tagline}
              </p>
            </div>
            ...
            <div className="flex flex-col items-start sm:items-end gap-4 shrink-0">
              ...
              <button
                className="px-6 py-3 text-xs font-semibold uppercase tracking-wider text-white transition-opacity hover:opacity-90 whitespace-nowrap"
