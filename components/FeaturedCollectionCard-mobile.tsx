...
export function FeaturedCollectionCardMobile({ project }: { project: Project }) {
  ...
  return (
    <Link href={`/projects/${project.slug}`} className="block group">
      <div className="w-full rounded-2xl overflow-hidden border border-white/10 relative" style={{ aspectRatio: "4/5" }}>
        {/* Background media */}
        <MediaRenderer
