      ...
      <div className="max-w-4xl mx-auto px-4 relative z-10">
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <p>If you have any questions about this privacy policy, please contact us at privacy@inceptionnft.com.</p>
          </section>

          <p className="mt-8 text-sm text-gray-400">Last updated: [Current Date]</p>
        </div>
      </div>
    </div>
  )
